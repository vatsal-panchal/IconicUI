    ...
    <section className="min-h-screen bg-white flex items-center justify-center px-4 py-10">
      <div className="container max-w-4xl mx-auto">
        <div className="text-center">
          ...
          <div
            className="h-[400px] bg-center bg-no-repeat mb-8"
            style={{
              backgroundImage:
      ...
      <a
        ...
        className="fixed top-7 left-7 w-12 h-12 flex items-center justify-center transition-transform duration-400 hover:scale-105 active:scale-95 group"
      >
        <div className="w-full h-full flex items-center justify-center">
          <svg
            className="w-full h-full fill-[#1a365d] transition-all duration-400 group-hover:scale-110 group-hover:drop-shadow-md"
          ...
          >
            <path
              className="stroke-[#1a365d] stroke-0 group-hover:animate-drawLogo group-hover:stroke-[1.5]"
              style={{
